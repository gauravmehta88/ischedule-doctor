...
@Component({
  ...
  templateUrl: "./doctor-email-verification.component.html",
  styleUrls: ["./doctor-email-verification.component.css"],
...
export class DoctorEmailVerificationComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.activatedRoute.queryParams.subscribe(params => {
      ...
      this.loginService.verifyEmail(EmailCode).subscribe(data => {
        if (data.IsSuccess) {
          this.loading = false;
